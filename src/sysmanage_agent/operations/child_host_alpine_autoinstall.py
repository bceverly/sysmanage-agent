...
echo "" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "auto_approve:" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  token: \\"{auto_approve_token}\\"" >> /etc/sysmanage-agent/sysmanage-agent.yaml"""
...
echo "# Auto-generated by VMM autoinstall for Alpine Linux" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "server:" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  hostname: \\"{server_hostname}\\"" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  port: {server_port}" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  use_https: {use_https_str}" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  verify_ssl: false" >> /etc/sysmanage-agent/sysmanage-agent.yaml{auto_approve_section}
echo "" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "client:" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  registration_retry_interval: 30" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  max_registration_retries: 10" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  update_check_interval: 3600" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "i18n:" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  language: \\"en\\"" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "logging:" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  level: \\"INFO|WARNING|ERROR|CRITICAL\\"" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  file: \\"/var/log/sysmanage-agent/agent.log\\"" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "websocket:" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  auto_reconnect: true" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  reconnect_interval: 5" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  ping_interval: 60" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "database:" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  path: \\"agent.db\\"" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  auto_migrate: true" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "script_execution:" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  enabled: true" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  timeout: 300" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  max_concurrent: 3" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "  allowed_shells:" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "    - \\"sh\\"" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "    - \\"ash\\"" >> /etc/sysmanage-agent/sysmanage-agent.yaml
echo "    - \\"bash\\"" >> /etc/sysmanage-agent/sysmanage-agent.yaml
"""
