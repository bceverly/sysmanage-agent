...
Delegation, initialization, edge-case, exception-handling, and return-value tests.
"""
...
class TestSystemOperationsDelegation:  # pylint: disable=too-many-public-methods
    """Delegation and related test cases for SystemOperations class."""
